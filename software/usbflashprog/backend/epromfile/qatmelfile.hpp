...
/**
 * @ingroup Software
 * @file backend/epromfile/qatmelfile.hpp
 * @brief Header of the QAtmelFile Class.
 *
 * @author Robson Martins (https://www.robsonmartins.com)
 */
// ---------------------------------------------------------------------------

#ifndef BACKEND_EPROMFILE_QATMELFILE_HPP_
#define BACKEND_EPROMFILE_QATMELFILE_HPP_
...
/**
 * @ingroup Software
 * @brief Atmel Generic Files Stream Class
 * @details The purpose of this class is to read and write data from/to a
 *   file, in Atmel Generic format.
 * @nosubgrouping
 */
class QAtmelFile : public QEpromFileBase {
    Q_OBJECT
  ...
  public:
     ...
     */
    explicit QAtmelFile(QObject *parent = nullptr);
    /**
...
#endif  // BACKEND_EPROMFILE_QATMELFILE_HPP_
