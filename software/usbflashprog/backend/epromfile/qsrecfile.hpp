...
#ifndef BACKEND_EPROMFILE_QSRECFILE_HPP_
#define BACKEND_EPROMFILE_QSRECFILE_HPP_
...
/**
 * @ingroup Software
 * @brief Motorola SREC Files Stream Class
...
class QSrecFile: public QEpromFileBase {
 ...
 public:
     ...
     */
    explicit QSrecFile(QObject *parent = nullptr);
    /**
