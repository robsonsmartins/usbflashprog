...
QEpromFileBase::QEpromFileBase(QObject *parent): QObject(parent),
        type_(EpromFileBin) {}

bool QEpromFileBase::isReadable(const QString &filename) {
    return false;
}

QString QEpromFileBase::getFilename(void) const {
    return filename_;
}
