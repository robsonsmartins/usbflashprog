 ...
 * @file    flash28f.cpp
 * @brief   Implementation file (C++) for Flash 28Fxxx Chip Emulation Library
 *
...
/* global vars */
/* Chip object */
static ChipFlash28F* objChip = NULL;
...
constexpr uint8_t kChipManufacturerId = 0x20;
/* @brief Hardcoded (emulated) Device ID: M28F256. */
constexpr uint8_t kChipDeviceId = 0xA8;
