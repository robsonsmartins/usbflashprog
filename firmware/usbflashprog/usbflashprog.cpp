...
constexpr float VPP_CALIBRATION = -0.370355424f;
constexpr float VDD_CALIBRATION = -0.087040620f;
...
void UsbFlashProg::init() {
    ...
    config_.vpp.calibration        =           VPP_CALIBRATION;
    ...
    config_.vdd.calibration        =           VDD_CALIBRATION;
